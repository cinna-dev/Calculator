...
calc.addEventListener('click', e => {
    ...
    //DCIMAL // allowed only if there was any input // decimal is only allowed once per num sets 'dot' bool to 'true' once entered // OPERATOR or EQUAL resets 'dot' bool to 'false again
